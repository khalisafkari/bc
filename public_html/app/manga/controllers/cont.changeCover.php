...
if(isset($_POST))
{
	...
	$ThumbPrefix			= "cover_"; //Normal thumb Prefix
	$DestinationDirectory	= '../uploads/covers/'; //Upload Directory ends with / (slash)
	$Quality 				= 80;
	...
	$NewImageName = md5($RandomNumber.time().$_SESSION[userId]).'.'.$ImageExt;
	...
	if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
	{
		...
		*/
		echo '/app/manga/uploads/covers/'.$NewImageName;
		unlink($DestinationDirectory.$thumb_final);
	}else{
