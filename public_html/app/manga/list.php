<?php
    ...
    }elseif ($list_array['magazine']) {
      $title = 'Manga List '.$list_array['magazine'];
      $desc = 'Manga List '.$list_array['magazine'].', Manga '.$list_array['magazine'].', Manga '.$list_array['magazine'].' | Read Manga Online LoveHug.Net';
      $keywords = 'Manga List '.$list_array['magazine'].', Manga '.$list_array['magazine'].' Manga '.$list_array['magazine'].' Read Manga Online LoveHug.Net';
    ...
    include 'themes/'.$c_manga['theme'].'/list.php';
