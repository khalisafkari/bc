<div class="card card-dark">
	...
	<div class="card-body bg-dark">
		<div class="row-last-update">
			...
			$thisMangaList7 = $db->Query(APP_TABLES_PREFIX.'manga_mangas', array('id','name','released','slug','last_chapter','post','m_status', 'views', 'cover'), array('hidden'=>0), NULL, NULL, array('post'=>'DESC'),7);

			foreach ($thisMangaList7 as $row) {
				...
				<div class="thumb-item-flow col-6 col-md-3">
					<div class="thumb-wrapper" data-id="5293" data-is-loaded="0">
						...
						<div class="thumb-detail">
							<div class="thumb_attr chapter-title text-truncate btn btn-xs btn-warning" style="background-color: #5c2040; border-color: #5c2040; width: 100%; font-size: 13px" title="<?=$lang['Chapter']?> <?=$row['last_chapter']?>">
					...
					<div class="thumb_attr series-title">
						<a href="/<?=$row['id']?>/" title="<?=$row['name']?>"><?=$row['name']?></a>
					</div>
				</div>
				<?php
			}
