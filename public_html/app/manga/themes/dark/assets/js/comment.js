				...
				),$("#commentbox").on("click",".cm-delete",function(t)
				{
					if(confirm("Are you sure you want to delete comments?"))
					{
						...
						$.ajax(
						{
							...
							,success:function(t)
							{
								// $(".list-comment").load(siteURL+"/app/manga/controllers/cont.listComment.php?act=list_comment&page=1&manga="+o),$("html, body").animate(
								// {
								// 	scrollTop:$("#comment_"+e).offset().top
								// }
								// ,1e3)
								console.log(e);
								$("div[data-id="+e+"]").html(t);
								$("html, body").animate({
									scrollTop:$("#comment_"+e).offset().top
								});
							}
