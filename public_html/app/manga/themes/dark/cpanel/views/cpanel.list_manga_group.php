...
if ($isGroup[0]['group_uploader'] == 0) {
	$user->alert('danger', 'You do not belong to any translation group!');
} else {
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		    ...
		    $('#UserTableContainer').jtable({
		    	...
		    	actions: {
		    		listAction: '/app/manga/controllers/cont.user.group.mangaManagement.php?action=list'
		    	},
		    	sorting: true,
		    	messages: {
		    		...
		    		name: {
		    			...
		    			display: function(data) {
		    				if (data.record.hidden == 1) {
		    					return '<a style="font-weight:bold;color:green;text-decoration: line-through;font-size:12px;" target="_blank" href="/'+data.record.id+'/">'+data.record.name+'</a>';
		    				} else {
