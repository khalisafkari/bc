...
if (!empty($checkUserGroup) || $check_submitter) {
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><?=$lang['Edit']?> <?=$lang['Chapter']?> (<?=$thisChapter['chapter']?> / <a href="/manage/list-chapter/manga-<?=$thisChapter['manga']?>.html"><strong><?=$thisChapter['manga']?></strong></a>)</h3>
			</div>
	...
	<?=$user->ajaxForm('addManga','/manage/list-chapter/'.$thisChapter['manga'].'.html')?>
	<?php
} else {
	$user->alert('danger', 'You can not edit chapter!');
}
?>
