		  ...
		  foreach ($data as $manga => $chapter) {
			...
			?>
				<div class="rd_sidebar-header clear">
					<a class="img" href="/<?=$thisManga[0]['id']?>/" style="background: url('<?=$thisManga[0]['cover']?>') no-repeat"></a>
					<div class="thumb_attr series-title">
						<a class="rd_sidebar-name"></a>
						<h5>
							<a href="/<?=$thisManga[0]['id']?>/"><?=str_replace('\' ', '\'', ucwords(str_replace('\'', '\' ', strtolower($thisManga[0]['name']))))?></a>
						</h5>
					</div>
				</div>
			  <?php
