	...
	<div class="container container_header">
		<div class="navbar-header">
			...
			?>
				...
				<a href="/<?=$thisManga['id']?>/" class="navbar-brand" style="font-size: 14px"><!--?=$c_manga['site_title']?--><i class="fa fa-book" aria-hidden="true"></i></a>
			<? } else {?>
				<a href="/" class="navbar-brand"><i class="fa fa-home" style="font-size: 20px" aria-hidden="true"></i>&nbsp;<?=$c_manga['site_title']?></a>
				<a href="/<?=$thisManga['id']?>/" class="navbar-brand" style="font-size: 14px"><i class="fa fa-book" aria-hidden="true"></i>&nbsp;Manga</a>
			<? }?>
