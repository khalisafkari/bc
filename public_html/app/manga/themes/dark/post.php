...
<head>
  ...
  <link rel="stylesheet" href="/app/manga/themes/dark/assets/css/base.css" media="screen">
...
<body>
 ...
 elseif($_GET['act'] == 'policy'){
	 include ROOT_DIR.'/app/manga/themes/dark/widgets/policy.php';
 } 
 else {
   //include ROOT_DIR.'/app/manga/themes/dark/widgets/list.'.$listType.'.php';
   include ROOT_DIR.'/app/manga/themes/dark/widgets/list.post.php';
 }
