...
<div class="topAll">
    ...
    <div class="tab-content card">
        <div class="tab-pane fade in active" id="week" role="tabpanel">
            <br>
            <?php
            $thisMangaW = $db->Query(APP_TABLES_PREFIX.'manga_views', array('manga','views'),array('type'=>2,'week'=>$week,'year'=>$year), NULL,NULL,array('views'=>'DESC'),15);
            foreach ($thisMangaW as $manga_views) {

              $thisMangaWeek = $db->Query(APP_TABLES_PREFIX.'manga_mangas','*',array('id'=>$manga_views['manga'],'hidden'=>0),NULL,NULL,NULL,15);
              ...
              foreach ($thisMangaWeek as $manga_views_week) {
                ...
                $other_name = !empty($manga_views_week['other_name']) ? $manga_views_week['other_name'] : "Updating";
      ...
      ?>
        ...
        <div class="tab-pane fade" id="month" role="tabpanel">
            <br>
            <?php
            $thisMangaM = $db->Query(APP_TABLES_PREFIX.'manga_views', array('manga','views'),array('type'=>3,'month'=>$month,'year'=>$year), NULL,NULL,array('views'=>'DESC'),15);
            ...
            foreach ($thisMangaM as $manga_views) {
              ...
              foreach ($thisMangaMonth as $manga_views_month) {
                ...
                $other_name = !empty($manga_views_month['other_name']) ? $manga_views_month['other_name'] : "Updating";
  ...
  <div class="tab-pane fade" id="year" role="tabpanel">
    ...
    <?php
              ...
              foreach ($thisMangaYear as $manga_views_year) {
                ...
                $other_name = !empty($manga_views_year['other_name']) ? $manga_views_year['other_name'] : "Updating";
