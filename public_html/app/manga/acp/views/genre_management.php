 ...
 <div class="col-lg-8">
	 <div class="panel panel-default">
	  <div class="panel-heading">
	    <h3 class="panel-title"><?php echo 'Genre Management'; ?></h3>
	  </div>
	  <div class="panel-body">
	  <p>
	  <div class="btn-group">
	  	<a href="app=mangaview=add-genre" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-plus"></i><?=$lang['Add-genre']?></a>
	  </div>
	  </p>
 ...
 <script type="text/javascript">
		...
		$(document).ready(function () {
			...
			$('#UserTableContainer').jtable({
				...
				actions: {
					listAction: '../app/manga/controllers/cont.genreManagement.php?action=list',
					deleteAction: '../app/manga/controllers/cont.genreManagement.php?action=delete'
				},
				sorting: true,
				messages: {
				...
				fields: {
					...
					MyButton: {
                		...
                		display: function(data) {
                     	...
                     	return '<div class="btn-group"><a href="app=mangaview=edit-genre&id='+data.record.id+'" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-wrench"></i> <?=$lang['Edit'] ?></a></div>';
                 }
           			},
				}
			});
